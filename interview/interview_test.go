...
func TestFastSort(t *testing.T) {
	list := []int{
		5, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7, 45, 10, 2, 1, 6, 7,
...
func TestHuaWeiStringHanle(t *testing.T) {
	date := []struct {
		a string
		k int
	}{
	...
	for k, v := range date {
		reuslt := HuaWeiStringHanle(v.a, v.k)
